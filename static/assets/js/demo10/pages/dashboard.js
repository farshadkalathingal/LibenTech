...
var KTDashboard = function() {
    ...
    var faturamento = function() {        
        ...
        var ctx = KTUtil.getByID('kt_chart_faturamento').getContext('2d');
        var myDoughnut = new Chart(ctx, config);
    }
            ...
            data: {
                ...
                source: {
                        "data": [
                            ...
                            {
                                "RecordID": 2,
                                "CompanyName": "Restaurante Bonna",
                                "ShipDate": "18\/12\/2018",
                                "Status": 2,
                                "Actions": null,
                                "Type": 1,
                                "CompanyAgent": "Victoria"
                            },
                            {
                                "RecordID": 3,
                                "CompanyName": "Roberto Silva",
                                "ShipDate": "18\/12\/2018",
                                "Status": 3,
                                "Actions": null,
                                "Type": 1,
                            ...
                            {
                                "RecordID": 4,
                                "CompanyName": "Papel & Celulose S/A",
                                "ShipDate": "18\/12\/2018",
                                "Status": 4,
                                "Actions": null,
                                "Type": 1,
